        ...
        if($ddh == "" || $xm == "" || $dz == "" || $xxdz == ""){
                ...
                if($cha_1['zt'] == 1) {
                    if ($cha_2['rwzl_zt'] == 0) {//入网资料
                        if ($jzxm == "" || $sfzh == "" || $mgz == "" || $sfz1 == "" || $sfz2 == "") {
                            ...
                            $DB->query("update mao_dindan set xm='{$xm}',dz='{$dz}',xxdz='{$xxdz}',ly='{$ly}',jzxm='{$jzxm}',sfzh='{$sfzh}',mgz='{$mgz}',sfz1='{$sfz1}',sfz2='{$sfz2}',shouji='{$shouji}' where M_id='{$mao['id']}' and id='{$cha_1['id']}'");
                            $result = array("code" => 0);
                            $_SESSION['ddh'] = $cha_1['ddh'];
                          $_SESSION['shouji'] = $shouji;
                        }
                    } else {
                        $DB->query("update mao_dindan set xm='{$xm}',dz='{$dz}',sjh='{$shouji}',xxdz='{$xxdz}',ly='{$ly}' where M_id='{$mao['id']}' and id='{$cha_1['id']}'");
                        $result = array("code" => 0);
                        $_SESSION['ddh'] = $cha_1['ddh'];
                       $_SESSION['shouji'] = $shouji;
                    }
            ...
            if($cha_2['rwzl_zt'] == 0){//入网资料
                if($jzxm == "" || $sfzh == "" || $mgz == "" || $sfz1 == "" || $sfz2 == ""){
                    ...
                    $DB->query("update mao_dindan set xm='{$xm}',dz='{$dz}',sjh='{$shouji}',xxdz='{$xxdz}',ly='{$ly}',jzxm='{$jzxm}',sfzh='{$sfzh}',mgz='{$mgz}',sfz1='{$sfz1}',sfz2='{$sfz2}' where M_id='{$mao['id']}' and id='{$cha_1['id']}'");
                    $result=array("code"=>0);
                    $_SESSION['ddh'] = $cha_1['ddh'];
                   $_SESSION['shouji'] = $shouji;
                }
