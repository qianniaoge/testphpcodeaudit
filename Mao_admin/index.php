...
<head>
    <meta charset="utf-8">
    <title><?php echo $mao['title']?> - 商城系统</title>
            ...
            <div class="layui-side layui-side-menu">
                <div class="layui-side-scroll">
                    ...
                    <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                        ...
                        <li data-name="new" class="layui-nav-item">
                            <a href="javascript:;" lay-tips="评价" lay-direction="2">
                                <i class="layui-icon layui-icon-cart"></i>
                                <cite>评价管理</cite>
                            </a>
                            <dl class="layui-nav-child">
                                <dd data-name="button">
                                    <a lay-href="Mao_evaluate/add.php">添加评价</a>
                                </dd>
                            </dl>
                            <dl class="layui-nav-child">
                                <dd data-name="button">
                                    <a lay-href="Mao_evaluate/list.php">评价列表</a>
                                </dd>
                            </dl>
                        </li>
                        ...
                        <li data-name="url" class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd data-name="button">
                                    <a lay-href="Mao_Order/weifukuan_list.php">未付款订单</a>
                                </dd>
                            </dl>
                            <dl class="layui-nav-child">
                                <dd data-name="button">
                                    <a lay-href="Mao_Order/weifahuo_list.php">未发货订单</a>
                                </dd>
                            </dl>
                            <dl class="layui-nav-child">
                                <dd data-name="button">
                                    <a lay-href="Mao_Order/yifahuo_list.php">已发货订单</a>
                                </dd>
                            </dl>
                        </li>
