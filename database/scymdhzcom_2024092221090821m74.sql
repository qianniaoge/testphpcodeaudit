...
CREATE TABLE `mao_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='网站设置';
...
INSERT INTO `mao_data` VALUES (1,'1','admin','123456a','抖店商城演示（电商专用）','111','111',4157.63,'新品上架，欢迎速购，满30减15','联系微信','1','15548184818','www.dy.mzmkj.com','shop.mzmkj.cn','2107-11-25','0','0','0','0','0','1000','YsffdqSORH0nT3JkgNAFVMQryVSfwwXm','https://pay.jiajingyu.com/','0','1','1','123456@qq.com','机器猫','','','','已售5万单');
...
CREATE TABLE `mao_dindan` (
  ...
  `msg` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=57 DEFAULT CHARSET=utf8 COMMENT='订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `mao_evaluate`
--

LOCK TABLES `mao_evaluate` WRITE;
/*!40000 ALTER TABLE `mao_evaluate` DISABLE KEYS */;
INSERT INTO `mao_evaluate` VALUES (20,'1','1',2,'李四','好吃，价格优惠','发货快,正品,质量很好','/upload/20240822221821521.jpg','/upload/20240822221821521.jpg',2,NULL,NULL,NULL,NULL,NULL),(22,'1','1',2,'张三','好吃，价格优惠','发货快,正品,质量很好','/upload/20240921213450299.png','/upload/20240921213453476.png',9,NULL,NULL,NULL,NULL,NULL),(32,'1','1',NULL,'****','物美价廉','好吃不贵','/upload/20240922115441138.png','/upload/20240922115503873.png',1,NULL,NULL,NULL,NULL,NULL),(33,'1','2',NULL,'****','物美价廉','好吃不贵','/upload/20240922115441138.png','/upload/20240922115503873.png',1,NULL,NULL,NULL,NULL,NULL),(34,'1','3',NULL,'****','物美价廉','好吃不贵','/upload/20240922115441138.png','/upload/20240922115503873.png',1,NULL,NULL,NULL,NULL,NULL),(35,'1','4',NULL,'****','物美价廉','好吃不贵','/upload/20240922115441138.png','/upload/20240922115503873.png',1,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `mao_evaluate` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-09-22 21:09:09
